    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-5xl mx-4 max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            <h2 className="text-xl font-semibold text-gray-900">Generate Client Quote</h2>
          ...
          <div className="flex items-center gap-4">
            ...
            {pricingMethod === 'markup' && (
              <div className="flex items-center gap-2 ml-4">
                <label className="text-sm text-gray-700">Global Markup:</label>
                <input
                  type="number"
                  value={globalMarkup}
            ...
            <div className="flex items-center gap-2 ml-4">
              <label className="text-sm text-gray-700">Tax Rate (VAT):</label>
              <input
                type="number"
                value={taxRate}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="space-y-4 mb-6">
            <h3 className="text-lg font-medium text-gray-900">Line Item Pricing</h3>

            {quoteItems.map((item, index) => (
              <div key={item.lineItemId} className="border border-gray-200 rounded-lg p-4 bg-white">
