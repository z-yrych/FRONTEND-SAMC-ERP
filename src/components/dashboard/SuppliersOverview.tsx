...
import { Plus, Edit, Trash2, Building2, X, Star, Clock, CheckCircle, XCircle } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="border border-gray-200 rounded-lg p-6">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8 bg-gray-50 rounded-lg border border-gray-200">
            <p className="text-gray-500 mb-2">No active suppliers</p>
            <p className="text-sm text-gray-400">All suppliers are currently inactive</p>
          </div>
        ) : (
