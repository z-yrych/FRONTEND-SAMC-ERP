...
export function RestockingMethodModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start sm:items-center justify-center z-50 overflow-y-auto p-4">
      <div className="bg-white rounded-lg w-full max-w-2xl my-4 sm:my-0 max-h-[90vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 flex-shrink-0">
          <div>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Restock Product</h2>
            <p className="text-xs sm:text-sm text-gray-600 mt-1">Choose how you'd like to proceed</p>
          </div>
          <button
            onClick={onClose}
